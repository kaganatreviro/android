...
public final class FragmentWebViewBinding implements ViewBinding {
  ...
  private FragmentWebViewBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppCompatImageButton btnBack, @NonNull Toolbar toolbar, @NonNull WebView webView) {
  ...
  public static FragmentWebViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentWebViewBinding((ConstraintLayout) rootView, btnBack, toolbar, webView);
    }

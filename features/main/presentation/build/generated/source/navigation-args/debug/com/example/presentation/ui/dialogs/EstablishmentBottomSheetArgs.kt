...
public data class EstablishmentBottomSheetArgs(
  ...
  public companion object {
    ...
    public fun fromBundle(bundle: Bundle): EstablishmentBottomSheetArgs {
      bundle.setClassLoader(EstablishmentBottomSheetArgs::class.java.classLoader)
      ...
      return EstablishmentBottomSheetArgs(__establishmentDetailsArg)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        EstablishmentBottomSheetArgs {
      val __establishmentDetailsArg : EstablishmentDetailsArg?
